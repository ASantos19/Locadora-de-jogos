...
import com.example.locadora_de_jogos.service.UsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<UsuarioModel> register(@RequestBody AuthRequest request) {
        UsuarioModel usuario = usuarioService.registrarUsuario(request.getUsername(), request.getPassword(), "ROLE_USER");
